...
<%@ include file="../include/header.jsp" %>
    <div class="container">
      ...
      <form action="../member/insert-process" method="post" class="needs-validation" novalidate
        ...
        <div class="row d-flex justify-content-center">
          <div class="col-6">
            <div class="mb-3">
              ...
              <input type="password" class="form-control" id="userPW" placeholder="user password" name="userPW" required />
        ...
        <div class="row d-flex justify-content-center">
          <div class="col-6">
            <div class="mb-3">
              ...
              <input type="password" class="form-control" id="userPW02" placeholder="user password" required/>
        ...
        <div class="row d-flex justify-content-center">
          <div class="col-6">
            <div class="mb-3">
              	...
              	maxlength="4" placeholder="user name" name="userName" required/>
          ...
          <div class="col-6">
            <div class="mb-3">
              ...
              placeholder="nick name" maxlength="5" name="nickName" required/>
        ...
        <div class="row d-flex justify-content-center">
          <div class="col-6">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="detailAddress" placeholder="detail address" name="detailAddress" required/>
         ...
         <div class="row d-flex justify-content-center">
          ...
          <div class="col-6">
            <div class="mb-3">
              ...
              <input type="text" maxlength="3" class="form-control tel01" id="tel01" placeholder="tel" name="tel01" required/>
              <h2>-</h2>
              <input type="text" maxlength="4" class="form-control tel01" id="tel02" name="tel02" required/>
              <h2>-</h2>
              <input type="text" maxlength="4" class="form-control tel01" id="tel03" name="tel03" required/>
              </div>
    ...
    <script> 
    	   ...
    	   $("#btnCheck").on("click",function(){
    		   if($("#checkNum").val() != emailCode){
    			   ...
    			   if($("#checkNum").val()==""){
    				   ...
    				   alert("인증번호 확인 되었습니다.");
    				   $("#checkNum").removeClass("is-invalid")
    				   $("#checkNum").addClass("is-valid")
      ...
      $("#detailAddress").on("keyup",function(){
          ...
          $("#detailAddress").addClass("is-valid")
