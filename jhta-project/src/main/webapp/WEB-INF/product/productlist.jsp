	...
	<c:forEach items="${ProductList }" var="Product">
		<div class="col">
			<div class="card shadow-sm">
				...
				<img class="bd-placeholder-img card-img-top" width="100%" height="225" src="${pageContext.request.contextPath }/upload/${Product.pdtThum}"></a>
				<div class="card-body">
					<p class="card-text">
					...
					<div class="d-flex justify-content-between align-items-center">
						<div class="btn-group">
							<button type="button" class="btn btn-sm btn-outline-secondary" onclick="location.href='../product/detail?pdtId=${Product.pdtId }'">
								<font style="vertical-align: inherit;"><font
									style="vertical-align: inherit;">상세보기</font></font>
							</button>
						...
						<small class="text-body-secondary"><font
							style="vertical-align: inherit;"><font
								style="vertical-align: inherit;">가격 : ${Product.pdtPrice }원</font></font></small>
					</div>
				</div>
			</div>
		</div>
