...
<div class="container">
	<form action="../codyboard/insert-process" method="post" enctype="multipart/form-data">
		<div class="mb-3">
		  <label for="exampleFormControlInput1" class="form-label">코디 게시판 글쓰기</label>
		  <input type="" class="form-control" id="codyBoardTitle" placeholder="제목을 작성해주세요." name="codyBoardTitle">
		</div>
		    <div class="mb-3">
		...
		<div class="mb-3">
		  ...
		  <textarea class="form-control" id="codyBoardContent" rows="3" name="codyBoardContent"></textarea>
		</div>
