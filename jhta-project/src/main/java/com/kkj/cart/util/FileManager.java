...
public class FileManager {
	/*
	 * .getSubmittedFileName() 메서드로 대체 public static String getFileName(Part part) {
	 * String realFileName = ""; String contentDisposition =
	...
	public void deleteImageFile(int pdtId, int partIndex) {
		String uploadDirectory = "C:\\upload\\";
		ImageDao imgDao = new ImageDao();
		ImageDto imgDto = imgDao.selectOneImg(pdtId);
