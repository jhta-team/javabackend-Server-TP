...
/**
 * Servlet implementation class MemberFindIDProcess
 */
public class MemberFindIDProcess extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MemberFindIDProcess() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		map.put("email", email);
		String userID = memberDao.findID(map);
		if(userID !=null) {
			String from_email ="kimhg1103@naver.com";
			String subject = "잊어버린 아이디 메일입니다.";
			String content = "<h3>" + "요청하신 아이디는" + "</h3> \r"+"<h2>"+userID+"</h2> \r"
					+"입니다.";
			...
			ScriptWriter.alertAndBack(response, "이메일과 이름을 확인해주세요");
		}
